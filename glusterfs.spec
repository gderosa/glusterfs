...
# rpmbuild -ta glusterfs-3.4.0alpha2.tar.gz --without rdma
...
# rpmbuild -ta glusterfs-3.4.0alpha2.tar.gz --without epoll
%{?_without_epoll:%global _without_epoll --disable-epoll}

# if you wish to compile an rpm with fusermount...
# rpmbuild -ta glusterfs-3.4.0alpha2.tar.gz --with fusermount
%{?_with_fusermount:%global _with_fusermount --enable-fusermount}

%global version 3.4.0alpha2
%if "%{version}" >= "3.2"
%global _can_georeplicate 1

# if you wish to compile an rpm without geo-replication support, compile like this...
# rpmbuild -ta glusterfs-3.4.0alpha2.tar.gz --without georeplication
%{?_without_georeplication:%global _without_georeplication --disable-geo-replication}
%endif

# if you wish to compile an rpm without the OCF resource agents...
# rpmbuild -ta glusterfs-3.4.0alpha2.tar.gz --without ocf
...
Source0: glusterfs-3.4.0alpha2.tar.gz
